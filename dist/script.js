...
var changeModalState = function changeModalState(state) {
  ...
  var bindActionToElmems = function bindActionToElmems(event, elem, prop) {
  ...
  bindActionToElmems('click', windowForm, 'form');
  bindActionToElmems('input', windowWidth, 'width');
  bindActionToElmems('input', windowHeight, 'height');
  bindActionToElmems('change', windowType, 'type');
  bindActionToElmems('change', windowProfile, 'profile');
};
